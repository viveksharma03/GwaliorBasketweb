  ...
  return (
    <Grid container item xs={12} md={7} gap={3}>
      ...
      >
        <div
          style={{
            ...
            fontWeight: "bold",
            fontSize: 20,
            display: props.products[0] ? "none" : "block",
          }}
        >
          Cart is Empty.
        </div>
              ...
              >
                <div style={{ display: "flex" }}>
                  ...
                  >
                    ...
                    <b style={{ fontSize: matches ? 14 : 16, marginTop: 10 }}>
                      Rs. {item.offerprice}
                    </b>
                  </div>
                </div>
      ...
      <Grid item xs={11.6} mx="auto" bgcolor="white" px={2} pb={1.5}>
        ...
        <p style={{ color: "gray", fontSize: matches && 14 }}>
          The enitire amount will be sent to your delivery partner.
        </p>
      ...
      >
        ...
        <p>
          ...
          <span style={{ color: "orange", cursor: "pointer" }}>Learn more</span>
        </p>
      </Grid>
    </Grid>
  );
