      ...
      <Grid container spacing={3} py={3} gap={3} justifyContent="center">
        ...
        <Grid item xs={12} md={3}>
          <Box
            ...
            py={!matches ? 6 : 2}
          >
            <img src="/assets/hiw1.webp" alt="/assets/hiw1.webp" width={65} />
            <div>
              <b>Place an order</b>
        ...
        <Grid item xs={12} md={3}>
          <Box
            ...
            py={!matches ? 6 : 2}
          >
            <img src="/assets/hiw2.png" alt="/assets/hiw2.png" width={80} />
            <div>
              <b>Don’t Blink</b>
              <div style={{ fontSize: 14, color: "gray" }}>
        ...
        <Grid item xs={12} md={3}>
          <Box
            ...
            py={!matches ? 6 : 2}
          >
            <img src="/assets/hiw3.jpg" alt="/assets/hiw3.jpg" width={80} />
            <div>
              <b>Enjoy</b>
              <div style={{ fontSize: !matches ? 14 : 12, color: "gray" }}>
      ...
      <Grid container py={4}>
        <Grid item xs={12} md={3} order={matches ? 1 : 0}>
          ...
          <p style={{ color: "gray", fontSize: 14 }}>
            © GwaliorBasket Technologies Private Limited
          </p>
        </Grid>
        <Grid
          item
          ...
          container
          gap={5}
          justifyContent={matches ? "start" : "space-evenly"}
          fontSize={14}
        >
          <ul
            style={{
