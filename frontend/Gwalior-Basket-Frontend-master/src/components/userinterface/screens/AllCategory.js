...
const AllCategory = () => {
  ...
  async function getProducts() {
    let result = await postData("userinterface/fetch_products", {
      ...
      return (
        ...
        >
          ...
          >
            ...
            />
            <p style={{ margin: matches && 0, textDecoration: "none" }}>
              {item.categoryname}
            </p>
          </Box>
        </Box>
          ...
          >
            <div style={{ height: "45%", marginTop: 5 }}>
              <img
                ...
                alt={`${ServerURL}/images/${item.productimage}`}
            ...
            <CardActions>
              <div
                style={{ fontSize: 15, marginRight: "auto", padding: "0 2px" }}
              >
                <s style={{ color: "gray", display: "block", fontSize: 12 }}>
                  {" "}
                  &#x20B9; {item.price}
                </s>
                <b> &#x20B9; {item.offerprice}</b>
