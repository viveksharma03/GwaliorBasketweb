    ...
    <div className={classes.mainContainer}>
      <div className={classes.box}>
        <Grid container spacing={2}>
          <Grid item xs={12} className={classes.rowStyle}>
            ...
            <div>
              <FormatListBulletedIcon
                onClick={() => navigate("/displayallcompanies")}
              />
            </div>
          </Grid>
          <Grid item xs={6}>
          ...
          <Grid item xs={6}>
            <TextField
              error={!error.ownerName ? false : true}
              helperText={error.ownerName}
              onFocus={() => handleError("ownerName", null)}
              value={ownerName}
              fullWidth
          ...
          <Grid item xs={6}>
            <TextField
              error={!error.emailAddress ? false : true}
              helperText={error.emailAddress}
              onFocus={() => handleError("emailAddress", null)}
              value={emailAddress}
              fullWidth
          ...
          <Grid item xs={6}>
            <FormControl fullWidth>
              ...
              <div style={{ padding: 5, fontSize: 12, color: "red" }}>
                {error.state}
              </div>
            </FormControl>
          </Grid>
